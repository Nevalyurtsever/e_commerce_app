...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Markdown(data: _data);
  }
}
...
- __Application__ refers to Enfa, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Enfa B.V, Holland.
...
- By email: info@en-fa.com




- By mail:  Pottumstraat 19, 3088 GP Rotterdam, Netherlands
''';
