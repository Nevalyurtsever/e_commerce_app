...
abstract class $CartModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String productId, int quantity, Product? product});
...
class _$CartModelImpl with DiagnosticableTreeMixin implements _CartModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CartModel(id: $id, productId: $productId, quantity: $quantity, product: $product)';
  }
...
abstract class _CartModel implements CartModel {
  factory _CartModel(
      ...
      required Product? product}) = _$CartModelImpl;
