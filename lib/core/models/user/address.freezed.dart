...
class _$AddressImpl implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, state: $state, city: $city, street: $street, no: $no, zipcode: $zipcode, town: $town, additionalAddress: $additionalAddress)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, country, state, city, street, no,
      zipcode, town, additionalAddress);
...
abstract class _Address implements Address {
  factory _Address(
      ...
      required final String? additionalAddress}) = _$AddressImpl;
